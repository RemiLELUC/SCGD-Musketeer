...
def train_sgd(seed,batch_size,epochs,
    ...
    np.save('sgd/loss_fashion_sgd_'+params_save+'.npy',loss_sgd)
    np.save('sgd/accuracy_fashion_sgd_'+params_save+'.npy',accuracy_list)
    return None
...
def train_musketeer(seed,batch_size,epochs,input_size,hidden_size,output_size,lr,ratio_changes,eta):
    ...
    # Initialize Musketeer evolution
    loss_musketeer = []
    accuracy_list = []
    # Main training loop
    ...
    np.save('musketeer'+str(eta)+'/loss_fashion_musketeer_'+params_save+'.npy',loss_cairos)
    np.save('musketeer'+str(eta)+'/accuracy_fashion_musketeer_'+params_save+'.npy',accuracy_list)
    np.save('musketeer'+str(eta)+'/g_info_fashion_'+params_save+'.npy',np.array(optimizer.param_groups[0]['g_info'].cpu()))
    return None
